...
public class JSONDecoder extends ByteToMessageDecoder {
	...
	public JSONDecoder(NetworkTrafficStat networkTrafficStat) {
	    this(DEFAULT_MAX_LENGTH, true, false);
     ...
     */
    public JSONDecoder(final int maxLength) {
     ...
     */
    public JSONDecoder(final int maxLength, final boolean stripDelimiter, final boolean failFast) {
