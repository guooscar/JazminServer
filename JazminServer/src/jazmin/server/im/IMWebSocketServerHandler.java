...
public class IMWebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
	private static Logger logger = LoggerFactory
			.get(IMWebSocketServerHandler.class);
	//
	private static final AttributeKey<IMSession> SESSION_KEY = AttributeKey.valueOf("s");
	private static final String WEBSOCKET_PATH = "/websocket";
	private WebSocketServerHandshaker handshaker;
	private IMMessageServer messageServer;

	public IMWebSocketServerHandler(IMMessageServer messageServer) {
	...
	private void handleWebSocketFrame(ChannelHandlerContext ctx,WebSocketFrame frame) {
		...
		IMRequestMessage message=decodeMessage(request.trim());
	...
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		IMWebSocketSession session = new IMWebSocketSession(ctx.channel(),messageServer);
	...
	//
	//--------------------------------------------------------------------------
	private IMRequestMessage decodeMessage(String s){
		IMRequestMessage reqMessage=new IMRequestMessage();
     	reqMessage.isBadRequest=false;
     	try {
			reqMessage.rawData=s.getBytes("UTF-8");
