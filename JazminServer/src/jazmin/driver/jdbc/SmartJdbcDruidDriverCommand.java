 ...
 *
 */
public class SmartJdbcDruidDriverCommand extends ConsoleCommand {
    private SmartJdbcDruidConnectionDriver connectionDriver;
	public SmartJdbcDruidDriverCommand() {
    	super(true);
    	id="smartjdbcdruid";
    	desc="smartjdbcdruid connection driver ctrl command";
    	...
    	//
    	connectionDriver=Jazmin.getDriver(SmartJdbcDruidConnectionDriver.class);
    }
	//
	@Override
